...
// let myTimeout;
//  let annoyingPopup = () => {
//    alert("HEY!! Have you seen super cool discounts?");
//  };
//
//
//
...
//
// function remindUser() {
//   alert("Hey, balloons are on SALE!! GET THEM BEFORE THEY FLOAT AWAY!!!");
// };
//
...
// let intervalAnswer = prompt("How lond do you want to wait in between?", "5 seconds");
//
// // 2. Take the response and create a setTimeout. After the time expires, alert the user with a random quote.
// let quotes = ["Be kind.", "Stay humble, hustle hard", "Never give up.", "There is no try, there is only do."];
//
// function createTimeout(time, type) {
...
//   let quoteChosen = Math.floor(Math.random() * maxIndex);
//   alert(quotes[quoteChosen]);
// }
//
// createTimeout(timeOutAnswer, "timeout");
// createTimeout(timeOutAnswer, "interval");
//
// // 4. Create two buttons: one that cancels the timeout, and one that cancels the interval.
//
